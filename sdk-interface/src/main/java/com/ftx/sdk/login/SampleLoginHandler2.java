...
@Component
@ChannelAnnotation(channelId = 10100, channelLabel = "sample", channelName = "模拟渠道")
public class SampleLoginHandler2 extends LoginHandlerAdapter {

    private Logger logger = LoggerFactory.getLogger(SampleLoginHandler2.class);
